setwd("C://R//how simple are tropical food webs//50perc//tri trophic png//abundance and interaction matrix from equal sampling")
...
setwd("C://R//how simple are tropical food webs//50perc//tri trophic png//abundance and interaction matrix from 1ha")
