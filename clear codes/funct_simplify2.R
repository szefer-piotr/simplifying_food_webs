...
# Helper functions for randoisation analysis.

# This is a version for parallelized computations and functions simplify2 lacks
# computations for the progress bars
...
simplify2 <- function(dataset, edge = "row", n = 1, reduction.level=0.8){
